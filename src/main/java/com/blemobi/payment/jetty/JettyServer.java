package com.blemobi.payment.jetty;
...
public class JettyServer {
	 ...
	 * @throws Exception
	 */
	public void startServer(final int port, final String packages) {
		ServletContextHandler context = new ServletContextHandler(ServletContextHandler.SESSIONS);
		context.setContextPath("/payment");
		...
		try {
			...
			log.info("Payment server catch an exception, Port[" + port + "] is used!");

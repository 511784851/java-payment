...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wx03f7cf69110e7c79";//微信开发平台应用id
	public static String APP_SECRET = "dd05cc7d0af623886eb79edb338c66c9";//应用对应的凭证
	
	public static String APP_KEY = "";//应用对应的密钥
	public static String PARTNER = "1358489302";//财付通商户号
	public static String PARTNER_KEY = "blemobiblemobiblemobiblemobi3721";//商户号对应的密钥
	...
	public static String notify_url = "http://47.88.5.139:8088/WeiXinpay-0.0.1-SNAPSHOT/payNotifyUrl.jsp";// 通知的URL
	...
	public static String traceid = "1358489302";//测试用户id
}

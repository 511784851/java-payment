...
public class IpFilterRule implements RuleValidator {
    ...
    public Map<String, String> validator(Map<String, String> params) {
        ...
        LOG.info("[IpFilterRule.validator] ip:{},yyuid:{}", ip, yyuid, TraceHelper.getTrace(params));
    ...
    private static boolean filerIp(String ip) {
        ...
        try {
            ...
            LOG.warn("[IpFilterRule.filterIp] taobao getIpData exception,ip:{},yyuid:{},respStr:{}", ip, respStr, e);
            return false;
        }
    }

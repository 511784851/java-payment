 ...
 * 
 */
@Service("szfLtAdapter")
public class SzfLtAdapter extends AbstractSzfAdapter {
    @Autowired
    DomainResource resource;
    private static final Logger LOG = LoggerFactory.getLogger(SzfLtAdapter.class);
    private static final String CARDTYPECOMBINE = "1";

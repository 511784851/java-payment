...
public interface KqConsts {
    ...
    static final String ADDR_YYPAY_NOTIFY = "/ch/notify/kq.do";
    static final String ADDR_YYPAY_RETURN = "/ch/return/kq.do";
    static final String ADDR_TIMESTAMP_QUERY = "http://www.99bill.com/gateway/getOrderTimestamp.htm";

    /** 密码以及证书地址 */
    // static final String PASSWORD = "123456"; // "guzhi123";
    /** 快钱非对称加密算法证书PFX文件名称 */
    // public static final String SECRET_KEY_FILE_NAME =
    // "channel/kq/yy-rsa.pfx"; // "src/main/resources/yy-rsa.pfx";
    // public static final String SECRET_KEY_FILE_NAME =
    // "/data/var/payplf-tpay.yy.com/certifications/yy-rsa.pfx";
    /** 快钱非对称加密算法证书CER文件名称 */
    // public static final String PUBLIC_KEY_FILE_NAME =
    // "channel/kq/public-rsa-yy.cer"; //
    // "src/main/resources/public-rsa-yy.cer";
    // public static final String PUBLIC_KEY_FILE_NAME =
    // "/data/var/payplf-tpay.yy.com/certifications/public-rsa-yy.cer";
    ...
    static final String ADDR_YYPAY_CARD_NOTIFY = "/ch/notify/kq/card.do";
    static final String ADDR_YYPAY_CARD_RETURN = "/ch/return/kq/card.do";

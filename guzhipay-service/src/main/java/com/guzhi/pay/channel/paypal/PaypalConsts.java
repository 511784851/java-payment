...
public interface PaypalConsts {
    ...
    static final String ADDR_YYPAY_PAYPALTOKEN = "/ch/notify/paypalToken.do";

    static final String ADDR_YYPAY_PAYPALCANCEL = "/ch/notify/paypalCancel.do";

    static final String ADDR_YYPAY_PAYPALNOTIFY = "/ch/notify/paypalBalance.do";

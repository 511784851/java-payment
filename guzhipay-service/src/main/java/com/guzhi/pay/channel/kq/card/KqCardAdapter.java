...
public abstract class KqCardAdapter extends AbstractKqAdatper implements ChannelIF {
    ...
    public PayOrder pay(PayOrder order) {
        ...
        request.put(KqConsts.KEY_BGURL, UrlHelper.removeLastSep(getPayNotify()) + KqConsts.ADDR_YYPAY_CARD_NOTIFY);
        request.put(KqConsts.KEY_PAGEURL, UrlHelper.removeLastSep(getPayNotify()) + KqConsts.ADDR_YYPAY_CARD_RETURN);
        ...
        String payUrl = UrlHelper.addQuestionMark(getPayKqAddr() + KqConsts.ADDR_CARD_PAY)
    ...
    public String getQueryAddress() {
        return getPayKqAddr() + KqConsts.ADDR_WEBSERVICE_QUERY;
    }
}

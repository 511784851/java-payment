 ...
 * 
 */
@Component("yeepayLtAdapter")
public class YeePayLtAdapter extends AbstractYeePayAdapter {
    private static Logger LOG = LoggerFactory.getLogger(YeePayLtAdapter.class);
    ...
    public PayOrder pay(PayOrder payOrder) {
        LOG.info("[YibaoLtAdapter.pay] in payOrder:{}", payOrder, TraceHelper.getTrace(payOrder));

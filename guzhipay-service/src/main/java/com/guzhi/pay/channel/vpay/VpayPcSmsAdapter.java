...
public class VpayPcSmsAdapter extends AbstractChannelIF {
    ...
    public PayOrder pay(PayOrder payOrder) {
        ...
        reqParams.put(VpayConsts.KEY_UID, JsonHelper.fromJson(payOrder.getUserId(), Consts.YYUID));
        ...
        reqParams.put(VpayConsts.KEY_SPSUC, getPayNotify() + VpayConsts.PC_NOTIFY_URL);
        ...
        LOG.info("generate pay url success for vpay pc sms,yyuid:{},orderid:{},payUrl:{}.",

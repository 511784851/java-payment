...
public class GatewayOrderQueryServiceLocator extends org.apache.axis.client.Service implements GatewayOrderQueryService {
    ...
    public GatewayOrderQueryServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (GatewayOrderQuery.class.isAssignableFrom(serviceEndpointInterface)) {
                GatewayOrderQuerySoapBindingStub _stub = new GatewayOrderQuerySoapBindingStub(new java.net.URL(
                        gatewayOrderQuery_address), this);
                _stub.setPortName(getgatewayOrderQueryWSDDServiceName());
                return _stub;
            }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://sandbox.99bill.com/apipay/services/gatewayOrderQuery",
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://sandbox.99bill.com/apipay/services/gatewayOrderQuery",
                    "gatewayOrderQuery"));
        }

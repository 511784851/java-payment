...
public interface ZfbConsts {
    ...
    static final String ADDR_YYPAY_NOTIFY = "/ch/notify/zfb.do";
    static final String ADDR_YYPAY_RETURN = "/ch/return/zfb.do";
    static final String ADDR_WAP_YYPAY_NOTIFY = "/ch/notify/zfbwap.do";
    static final String ADDR_WAP_YYPAY_RETURN = "/ch/return/zfbwap.do";
    static final String ADDR_WAP_APP_YYPAY_NOTIFY = "/ch/notify/zfbwapapp.do";

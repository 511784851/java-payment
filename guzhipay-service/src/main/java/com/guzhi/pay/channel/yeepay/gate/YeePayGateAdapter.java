...
public class YeePayGateAdapter extends AbstractYeePayAdapter {
    ...
    public PayOrder pay(PayOrder payOrder) {
        ...
        reqParams.put(YeePayConsts.P5_PID, "guzhi");
        reqParams.put(YeePayConsts.P6_PCAT, "guzhi");
        reqParams.put(YeePayConsts.P7_PDESC, "guzhi");

        reqParams.put(YeePayConsts.P8_URL, getPayNotify() + YeePayConsts.ADDR_YEEPAY_GATE_NOTIFY);
        ...
        LOG.info("[YbGateAdapter.pay] return payOrder:{}", payOrder, "ds:trace:" + payOrder.getAppOrderId());
        return payOrder;
    }

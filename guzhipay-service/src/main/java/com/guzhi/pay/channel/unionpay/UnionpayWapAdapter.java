...
public class UnionpayWapAdapter extends AbstractChannelIF {
    ...
    public PayOrder pay(PayOrder payOrder) {
        ...
        String frontUrl = UnionpayWapHelper.generateFrontUrl(payOrder, getPayNotify());
        ...
        request.put(Constants.KEY_BACKURL, UrlHelper.removeLastSep(getPayNotify()) + Constants.NOTIFYURL);

...
public class PaypalBalanceAdapter extends AbstractChannelIF {
    ...
    public void init() {
        ...
        ADDR_PAYPAL_NOTIFYURL = UrlHelper.removeLastSep(getPayNotify()) + PaypalConsts.ADDR_YYPAY_PAYPALNOTIFY;
    }
    ...
    public PayOrder pay(PayOrder payOrder) {
        ...
        request.put(PaypalConsts.RETURNURL, UrlHelper.removeLastSep(getPayNotify())
                + PaypalConsts.ADDR_YYPAY_PAYPALTOKEN);
        request.put(PaypalConsts.CANCELURL, UrlHelper.removeLastSep(getPayNotify())
                + PaypalConsts.ADDR_YYPAY_PAYPALCANCEL);
        request.put(PaypalConsts.PAYMENTREQUEST_0_NOTIFYURL, UrlHelper.removeLastSep(getPayNotify())
                + PaypalConsts.ADDR_YYPAY_PAYPALNOTIFY);

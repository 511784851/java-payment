...
public class KqStatusMsgHelper {
    ...
    public interface CardPayResponseReturnCode {
        ...
        String RETURN_MSG_10012 = "订单提交时间不正确,请输入以yyyyMMddhhmmss格式的时间字符串";
        ...
        String RETURN_MSG_30025 = "订单提交时间为空或格式不正确（正确格式为：yyyyMMddHHmmss.例如20080913090103）";
    ...
    public interface BankPayResponseErrCode {
        ...
        String ERR_MSG_10012 = "订单提交时间不正确,请输入以yyyyMMddhhmmss格式的时间字符串";
        ...
        String ERR_MSG_10061 = "订单时间戳格式不正确,请输入以yyyyMMddHHmmss格式的时间戳";

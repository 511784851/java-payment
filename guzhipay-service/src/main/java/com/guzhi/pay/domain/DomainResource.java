...
public class DomainResource {
    ...
    public String getHisTotalAmount(String yyuid, String chId) {
        return userTransInfoMapper.getHisTotalAmount(yyuid, chId);
    }

    public String getHisTotalAmountByTime(String yyuid, String chId, String startTime, String endTime) {
        return userTransInfoMapper.getHisTotalAmountByTime(yyuid, chId, startTime, endTime);
    }
    ...
    public int getYyCrospPaypal(String yyuid, String chId, String startTime, String endTime, String exAccount) {
        return userTransInfoMapper.getYyCrospPaypal(yyuid, chId, startTime, endTime, exAccount);
    }
    ...
    public int getPayTimesByEndTime(String yyuid, String chId, String endTime) {
        return userTransInfoMapper.getPayTimesByEndTime(yyuid, chId, endTime);
    }

...
public class TimeHelper {
    ...
    // 以gbyMMddHHmmss 4位年+2位月+2位日+2位时+2位分+2位秒的格式返回当前时间。
    public static final String TIME_FORMATE = "gbgbMMddHHmmss";
    public static final String TIME_FORMATE1 = "gbgb-MM-dd HH:mm:ss";
    ...
    public static String get(int formatType, Date date) {
        ...
        if (formatType == 1) {
            sdf = new SimpleDateFormat("gbgb-MM-dd HH:mm:ss");
        } else if (formatType == 2) {
            sdf = new SimpleDateFormat("gbgb/MM/dd HH:mm:ss");
        } else if (formatType == 3) {
            sdf = new SimpleDateFormat("gbgb年MM月dd日 HH:mm:ss");
        } else if (formatType == 4) {
            sdf = new SimpleDateFormat("gbgb年MM月dd日 HH时mm分ss秒");
        } else if (formatType == 5) {
            sdf = new SimpleDateFormat("gbgb年MM月dd日 E HH:mm:ss");
        } else if (formatType == 6) {
            sdf = new SimpleDateFormat("gbgb年MM月dd日 E HH时mm分ss秒");
        } else if (formatType == 7) {
            sdf = new SimpleDateFormat("gbgbMMdd");
        } else if (formatType == 8) {
            sdf = new SimpleDateFormat("gbgbMMddHHmmss");
        } else {
            sdf = new SimpleDateFormat("gbgbMMddHHmmss");
        }
    ...
    /**
     * 把字符串格式化为gbgb-MM-dd HH:mm:ss形式的时间Date
     * 
     * @param String
     * @return Date
    ...
    /**
     * 按照gbgb-MM-dd HH:mm:ss的格式，字符串转日期
     * 
     * @param String
     * @return Date
     */
    public static Date str2Date(String date) {
        if (!StringUtils.isBlank(date)) {
            SimpleDateFormat sdf = new SimpleDateFormat("gbgb-MM-dd HH:mm:ss");
            sdf.setLenient(false);
            try {

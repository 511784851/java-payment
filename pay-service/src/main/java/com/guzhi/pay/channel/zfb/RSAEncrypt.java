    ...
    public static String sign(String signMsg, String privateKeyFilePath, String password) {
        ...
        try {
            ...
            if (keyStoreMap.containsKey(privateKeyFilePath)) {
                ...
                byte[] kegbytes = Base64.decodeBase64(FileUtil.readFile(privateKeyFilePath));
                PKCS8EncodedKeySpec keySpec = new PKCS8EncodedKeySpec(kegbytes);
    ...
    public static boolean checkSign(String data, String sign, String publicKeyPath) {
        ...
        try {
            ...
            if (keyStoreMap.containsKey(publicKeyPath)) {
                ...
                byte[] kegbytes = Base64.decodeBase64(fileContent);
                KeyFactory keyFactory = KeyFactory.getInstance(RSA);
                publicKey = keyFactory.generatePublic(new X509EncodedKeySpec(kegbytes));

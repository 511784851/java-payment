...
public class KqHelper {
    ...
    private final static String TIMESTAMP_FORMAT = "gbgbMMddHHmmss";
    ...
    public static String assembleNotifySuccessUrl(String url) {
        ...
        sb.append(KqConsts.NOTIFY_RESULT_SUCCESS).append(KqConsts.REDIRECTURL).append(url)
                .append(KqConsts.ADDR_guzhiPay_RETURN).append(KqConsts.UREDIRECTURL);
        return sb.toString();
    }
    ...
    public static String assembleNotifySuccessUrl(String url, boolean isCard) {
        if (isCard) {
            StringBuilder sb = new StringBuilder();
            sb.append(KqConsts.NOTIFY_RESULT_SUCCESS).append(KqConsts.REDIRECTURL).append(url)
                    .append(KqConsts.ADDR_guzhiPay_CARD_RETURN).append(KqConsts.UREDIRECTURL);
            return sb.toString();
        } else {

...
public class GatewayOrderQueryResponse implements java.io.Serializable {
    ...
    public GatewayOrderQueryResponse(java.lang.String currentPage, java.lang.String errCode,
            java.lang.String merchantAcctId, GatewayOrderDetail[] orders, java.lang.String pageCount,
            java.lang.String pageSize, java.lang.String recordCount, java.lang.String signMsg, int signType,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://gatewayquery.dto.domain.seashell.bill99.com",
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://gatewayquery.dto.domain.seashell.bill99.com",
                "GatewayOrderDetail"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();

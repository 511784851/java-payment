...
public class QihuGateAdapter extends AbstractChannelIF {
    ...
    public PayOrder pay(PayOrder order) {
        ...
        request.put(QihuConsts.KEY_NOTIFY_URL, UrlHelper.removeLastSep(getguzhiPayNotify()) + QihuConsts.ADDR_guzhiPay_NOTIFY);
        request.put(QihuConsts.KEY_RETURN_URL, UrlHelper.removeLastSep(getguzhiPayNotify()) + QihuConsts.ADDR_guzhiPay_RETURN);

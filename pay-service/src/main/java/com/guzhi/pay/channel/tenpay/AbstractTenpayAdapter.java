...
public abstract class AbstractTenpayAdapter extends AbstractChannelIF {
    ...
    public PayOrder pay(PayOrder payOrder) {
        ...
        dataMap.put(TenpayConsts.KEY_RETURN_URL, UrlHelper.removeLastSep(getguzhiPayNotify())
                + TenpayConsts.ADDR_guzhiPay_RETURN);
        dataMap.put(TenpayConsts.KEY_NOTIFY_URL, UrlHelper.removeLastSep(getguzhiPayNotify())
                + TenpayConsts.ADDR_guzhiPay_NOTIFY);

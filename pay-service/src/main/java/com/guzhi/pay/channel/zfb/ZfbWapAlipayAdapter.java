...
public class ZfbWapAlipayAdapter extends AbstractZfbAdapter implements ChannelIF {
    ...
    private String getToken(PayOrder payOrder) {
        ...
        requDataMap.put(ZfbConsts.Wap.CALL_BACK_URL, UrlHelper.removeLastSep(getguzhiPayNotify())
                + ZfbConsts.ADDR_WAP_guzhiPay_RETURN);
        requDataMap.put(ZfbConsts.KEY_NOTIFY_URL, UrlHelper.removeLastSep(getguzhiPayNotify())
                + ZfbConsts.ADDR_WAP_guzhiPay_NOTIFY);

...
/**
 * <p>subProductEvt complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="subProductEvt">
 *   &lt;complexContent>
...
@XmlType(name = "subProductEvt", propOrder = {
    "callNumber",
    "productId"
})
@XmlSeeAlso({
    SubProductWithVCodeEvt.class,
    BuyProductEvt.class
})
public class SubProductEvt

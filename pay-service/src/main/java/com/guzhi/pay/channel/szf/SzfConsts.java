...
public interface SzfConsts {
    ...
    static final String ADDR_guzhiPay_RETURN = "http://api.pay.gb.com/ch/return/szfSzx";

    // static final String ADDR_guzhiPay_NOTIFY =
    // "http://api.payplf.gb.com/ch/notify/szfSzx.do";

    static final String ADDR_guzhiPay_NOTIFY = "/ch/notify/szfSzx.do";

...
public class AbstractZfbAdapter extends AbstractChannelIF {
    ...
    public PayOrder pay(PayOrder order) {
        ...
        // ZfbConsts.ADDR_guzhiPay_NOTIFY);
        request.put(ZfbConsts.KEY_NOTIFY_URL,
                UrlHelper.removeLastSep(getguzhiPayNotify()) + ZfbConsts.ADDR_guzhiPay_NOTIFY);
        ...
        if (StringUtils.isNotBlank(order.getReturnUrl())) {
            request.put(ZfbConsts.KEY_RETURN_URL,
                    UrlHelper.removeLastSep(getguzhiPayNotify()) + ZfbConsts.ADDR_guzhiPay_RETURN);
        }
    ...
    public PayOrder refund(PayOrder payOrder) {
        ...
        // request.put(ZfbConsts.KEY_NOTIFY_URL,
        // ZfbConsts.ADDR_guzhiPay_NOTIFY);//异步通知商户地址
        request.put(ZfbConsts.KEY_NOTIFY_URL,
                UrlHelper.removeLastSep(getguzhiPayNotify()) + ZfbConsts.ADDR_guzhiPay_NOTIFY);// 异步通知商户地址

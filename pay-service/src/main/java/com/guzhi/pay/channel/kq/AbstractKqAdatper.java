...
public abstract class AbstractKqAdatper extends AbstractChannelIF {
    ...
    // 增加银行直连地址（URL）常量
    @Value("${guzhiPayKqAddr}")
    protected String guzhiPayKqAddr;

    public String getguzhiPayKqAddr() {
        return guzhiPayKqAddr;
    }

    public void setguzhiPayKqAddr(String guzhiPayKqAddr) {
        this.guzhiPayKqAddr = guzhiPayKqAddr;
    }

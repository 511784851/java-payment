...
public abstract class AbstractChannelIF implements ChannelIF {
    ...
    // 增加通知常量
    @Value("${guzhiPayNotify}")
    protected String guzhiPayNotify;

    public String getguzhiPayNotify() {
        return guzhiPayNotify;
    }

    public void setguzhiPayNotify(String guzhiPayNotify) {
        this.guzhiPayNotify = guzhiPayNotify;
    }

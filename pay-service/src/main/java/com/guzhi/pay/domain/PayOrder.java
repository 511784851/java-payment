...
/**
 * 支付订单类，主要信息都在这里。<br>
 * 为避免文档重复，主要的说明请见接口文档（guzhiPay/docs），这里仅作必要补充。 <br>
...
public class PayOrder {
    ...
    @NotBlank(groups = { PayReqVal.class, QueryReqVal.class,
            RefundReqVal.class }, message = "appOrderId must not be blank.")
    ...
    public String toString() {
        return "PayOrder [appId=" + appId + ", appOrderId=" + appOrderId + ", chId=" + chId + ", appOrderTime="
                ...
                + ",gbAmount=" + gbAmount + ",ext=" + ext + ", prodId=" + prodId + ", prodName=" + prodName
    ...
    public String getgbOper() {
        return gbOper;
    }

    public void setgbOper(String gbOper) {
        this.gbOper = gbOper;
    }
    ...
    public void setgbAmount(BigDecimal gbAmount) {

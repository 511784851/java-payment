...
public class MaskCodeInfo implements TBase<MaskCodeInfo, MaskCodeInfo._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("MaskCodeInfo");
  ...
  private static final int __LENFRONT_ISSET_ID = 0;
  private static final int __LENBACK_ISSET_ID = 1;
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(MaskCodeInfo.class, metaDataMap);
  }
   ...
   */
  public MaskCodeInfo(MaskCodeInfo other) {
  ...
  public MaskCodeInfo deepCopy() {
    return new MaskCodeInfo(this);
  }
  ...
  public MaskCodeInfo setRequest(String request) {
    this.request = request;
    return this;
  }
  ...
  public MaskCodeInfo setLenFront(int lenFront) {
    this.lenFront = lenFront;
    setLenFrontIsSet(true);
    return this;
  }
  ...
  public MaskCodeInfo setLenBack(int lenBack) {
    this.lenBack = lenBack;
    setLenBackIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MaskCodeInfo)
      return this.equals((MaskCodeInfo)that);
    return false;
  }

  public boolean equals(MaskCodeInfo that) {
    if (that == null)
      return false;
  ...
  public int compareTo(MaskCodeInfo other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    MaskCodeInfo typedOther = (MaskCodeInfo)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MaskCodeInfo(");
    boolean first = true;

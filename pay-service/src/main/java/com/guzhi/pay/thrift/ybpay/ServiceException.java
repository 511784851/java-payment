 ...
 * 异常定义
 */
public class ServiceException extends Exception implements TBase<ServiceException, ServiceException._Fields>,
    ...
    static {
        ...
        tmpMap.put(_Fields.WHY, new FieldMetaData("why", TFieldRequirementType.REQUIRED, new FieldValueMetaData(
                TType.STRING)));
    ...
    public ServiceException(String why) {
        this();
        this.why = why;
    }

...
public class UrlGenerateTest {
    ...
    private static String DEBUG_TPAYURL = "https://payplf-tpay-test.yy.com";
    private static String PROD_TPAYURL = "https://payplf-tpay.yy.com";
    private static String DEBUG_GATEURL = "https://payplf-gate-test.yy.com";
    private static String PROD_GATEURL = "https://payplf-gate.yy.com";
    ...
    public static void main(String[] args) throws Exception {
        while (true) {
            ...
            values = new ObjectMapper()
                    .readValue(
                            "{\"appId\":\"101\",\"appOrderId\":\"201311010833022000\",\"chId\":\"Zfb\",\"appOrderTime\":\"20131101083302\",\"payMethod\":\"WapApp\",\"amount\":0.02,\"bankId\":\"\",\"statusCode\":\"CODE_PENDING\",\"statusMsg\":\"等待用户支付，或等待支付宝通知\",\"chOrderId\":\"101201311010833022000\",\"chAccountId\":\"2088111050324223\",\"submitTime\":\"20131101163303\",\"lastUpdateTime\":\"20131101163303\",\"payUrl\":\"service=\\\"mobile.securitypay.pay\\\"&partner=\\\"2088111050324223\\\"&_input_charset=\\\"utf-8\\\"&notify_url=\\\"https%3A%2F%2Fpayplf-tpay-test.yy.com%2Fch%2Fnotify%2Fzfbwapapp.do\\\"&out_trade_no=\\\"101201311010833022000\\\"&subject=\\\"欢聚支付平台测试\\\"&payment_type=\\\"1\\\"&seller_id=\\\"payplf@yy.com\\\"&total_fee=\\\"0.02\\\"&sign_type=\\\"RSA\\\"&sign=\\\"SOHlKmN9Dv%2Fm%2B%2BZJ2WK7kGbxebuiWvAvlW4KBD9etIPUgItzld%2BeZbVZMGQ3bWkvjmOI0yuTALpJNxhD6XE7YuRVb55bKotsIYhVIveSDj7UBwuAAySfZYNxEjygQJbivWkqQPZsBxDVtLPA7lqrIpK3PJoWfJjVdDt1z7oS5qo%3D\\\"\"}",
                            Map.class);
            ...
            // String payUrlFor99BillSzx = genFiftyYuanPayUrlFor99BillSzx();
            // System.out.println("[genFiftyYuanPayUrlFor99BillSzx]");
            ...
            // String payUrlForSzfSzx = genFiftyYuanPayUrlForSzf();
    ...
    public void genAuthUrl() {
        ...
        String sign = SecureHelper.genMd5Sign(KEY, dataString);
        String authUrlForYbWapBalance = TPAYURL + "/ch/util/authYb.do?appId=" + APPID + "&sign=" + sign + "&data="
                + dataString;
        System.out.println(authUrlForYbWapBalance);
    }

    @Test
    public void genOneYuanPayUrlForYbWapBalance() {
        ...
        String sign = SecureHelper.genMd5Sign(KEY, dataString);
        String payUrlForYbWapBalance = TPAYURL + "/pay.do?appId=" + APPID + "&sign=" + sign + "&data=" + dataString;
        System.out.println(payUrlForYbWapBalance);
    }

    private static Map<String, Object> genRequestMap() {
        final String appOrderTime = new SimpleDateFormat("yyyyMMddHHmmss").format(new Date());
    ...
    public void tenpayWeixin() {
        ...
        payOrder.setYyAmount(new BigDecimal("200.00"));
    ...
    public void tenpayGate() {
        ...
        payOrder.setYyAmount(new BigDecimal("0.01"));
        payOrder.setAutoRedirect("false");
        System.out.println(buildRequestUrl(payOrder));
    }

    @Test
    public void tenpayBalance() {
        PayOrder payOrder = new PayOrder();
        payOrder.setChId("Tenpay");
    ...
    private static String genTenYuanPayUrlForBroadBandTxtong() throws JsonProcessingException {
        ...
        String appOrderTime = new SimpleDateFormat("yyyyMMddHHmmss").format(new Date());
        String appOrderId = appOrderTime + "2000";
        String chId = "Broadband";
        String payMethod = "txtong";
        String amount = "10";
        String prodName = "天下通10元";
        String notifyUrl = "http://www.yy.com";
        ...
        data.put("userId", "{\"yyuid\":\"50012910\"}");
    ...
    private static String genFiveYuanPayUrlForVpayPCSms() throws Exception {
        ...
        String urlPrefix = "https://payplf-tpay.yy.com/pay.do?appId=";

        // For test
        // String appId = "101";
        // String key = "1a2b3c4d5e6f7g8h9i0j";
        // String urlPrefix = "https://payplf-tpay-test.yy.com/pay.do?appId=";
    ...
    private static String genTwoCentPayUrlForWapAli() throws Exception {
        ...
        String url = "https://payplf-tpay-test.yy.com/pay.do?appId=" + appId + "&data=" + dataString + "&sign=" + sign;
        return url;
    }
    ...
    private static String genTwoCentPayUrlForWapApp2Gate() throws Exception {
        ...
        // String url = "http://payplf-gate-test.yy.com/pay.do?appId=" + appId +
        // "&data="
        // + StringHelper.encodeStr(dataString) + "&sign=" + "test";

        String url = "https://payplf-gate-test.yy.com/ut/wap/recharge.do?appId=" + appId + "&sign=test" + "&data="
                + dataString;
        return url;
    }
    ...
    private static String genLimitPayUrlForZfbGate() throws Exception {
        ...
        String bankId = "";
        String notifyUrl = "http://www.guzhi.com";
        String returnUrl = "http://www.yy.com";
        String autoRedirect = "false";
        ...
        String dataString = new ObjectMapper().writeValueAsString(data);
        String sign = SecureHelper.genMd5Sign("1a2b3c4d5e6f7g8h9i0j", dataString);
        String url = "https://payplf-tpay-test.yy.com/pay.do?appId=101&data=" + dataString + "&sign=" + sign;
        return url;
    }

    private static String genLimitPayUrlForYbBalance() throws Exception {
        String appId = "101";
        String appOrderTime = new SimpleDateFormat("yyyyMMddHHmmss").format(new Date());
        String appOrderId = appOrderTime + "3000";
        String chId = "Yb";
        ...
        // TODO maybe not necessary
        String bankId = "CMB";
        String notifyUrl = "https://payplf-tpay.yy.com/ch/notify/zfb";
        String autoRedirect = "true";
        ...
        String dataString = new ObjectMapper().writeValueAsString(data);
        String sign = SecureHelper.genMd5Sign("1a2b3c4d5e6f7g8h9i0j", dataString);
        String url = "https://payplf-tpay.yy.com/pay.do?appId=101&data=" + dataString + "&sign=" + sign;
        return url;
    }
    ...
    private static String genOneCentPayUrlForUnionpayWap() throws Exception {
        ...
        data.put("appOrderTime", appOrderTime);
        data.put("amount", amount);
        data.put("returnUrl", "http://www.yy.com");
    ...
    private static String genOneCentPayUrlForYeePayGate() throws Exception {
        ...
        data.put("userId", "{\"yyuid\":\"50012910\"}");
        // data.put("bankId", "CMB");
        data.put("yyOper", yyOper);
        data.put("yyAmount", yyAmount);
        // data.put("autoRedirect", autoRedirect);
        String dataString = new ObjectMapper().writeValueAsString(data);
        String sign = SecureHelper.genMd5Sign("1a2b3c4d5e6f7g8h9i0j", dataString);
        String url = "https://payplf-tpay-test.yy.com/pay.do?appId=" + appId + "&data=" + dataString + "&sign=" + sign;
    ...
    private static String genOneYuanPayUrlForYeePayCard() throws Exception {
        ...
        String amount = "1.00";
        String prodId = "多玩Y币ID";
        String prodName = "多玩Y币Name";
        String prodDesc = "多玩Y币Desc";
        String cardTotalAmount = "50.00";
        String notifyUrl = "http://www.yy.com";
        String autoRedirect = "false";
        String userId = "{\"yyuid\":\"50012910\"}";
    ...
    private static String genOneCentPayUrlForZfbGateAndDeposit() throws Exception {
        ...
        data.put("userIp", "183.60.177.228");
        data.put("yyOper", "ad");
        data.put("yyAmount", "0.01");
        data.put("userId", userId);
        data.put("autoRedirect", autoRedirect);
        String dataString = new ObjectMapper().writeValueAsString(data);
        String sign = SecureHelper.genMd5Sign(key, dataString);
        String url = "https://payplf-tpay-test.yy.com/pay.do?appId=" + appId + "&data="
    ...
    private static String genOneYuanPayUrlFor99BillBalance() throws IOException {
        ...
        String amount = "1.00";
        String prodId = "Y币ID";
        String prodName = "Y币Name";
        String prodDesc = "Y币Desc";
        String notifyUrl = "http://www.yy.com";
        String returnUrl = "http://www.guzhi.com";
        String userId = "{\"yyuid\":\"50012910\"}";
    ...
    private static String genOneYuanPayUrlFor99BillSd() throws IOException {
        ...
        // String prodId = "guzhiID";
        // String prodName = "guzhiName";
        // String prodDesc = "guzhiDesc";
        String notifyUrl = "http://www.yy.com";
        String returnUrl = "http://www.guzhi.com";
        String autoRedirect = "false";
        String userId = "{\"yyuid\":\"50012910\"}";
    ...
    private static String genFiftyYuanPayUrlFor99BillSzx() throws IOException {
        String appId = "106";
        String key = "93F0A76053EF9EB4";
    ...
    private static String genFiftyYuanPayUrlForSzf() throws IOException {
        // For test
        String appId = "101";
        String key = "1a2b3c4d5e6f7g8h9i0j";
        String passwdKey = "test";
    ...
    private static String genOneYuanPayUrlFor99BillWy() throws IOException {
        ...
        String amount = "10.00";
        String prodId = "YBID";
        String prodName = "YBName";
        String prodDesc = "YBDesc";
        String notifyUrl = "http://www.yy.com";
        String returnUrl = "http://www.guzhi.com";
        // String autoRedirect = "false";
        String userId = "{\"yyuid\":\"50012910\"}";
    ...
    private String buildRequestUrl(PayOrder payOrder) {
        ...
        data.put("yyAmount", payOrder.getYyAmount() == null ? "1.00" : payOrder.getYyAmount().toPlainString());
        data.put("prodId", getDefaultStringIfBlank(payOrder.getProdId(), "1YB"));
        data.put("prodName", getDefaultStringIfBlank(payOrder.getProdName(), "1元Y币测试商品名称"));
        data.put("prodDesc", getDefaultStringIfBlank(payOrder.getProdDesc(), "1元Y币测试商品描述"));
        ...
        data.put("userId", getDefaultStringIfBlank(payOrder.getUserId(), "{\"yyuid\":\"50012910\"}"));

...
public class AlipayAddGbTest {
    ...
    public void testPay() throws Exception {
        ...
        treq.setAppId("101");
        treq.setData(
                "{\"appOrderId\":\"201305141518300018\",\"chId\":\"zfb\",\"payMethod\":\"gate\",\"appOrderTime\":\"20130514151830\","
    ...
    public void testRefund() throws Exception {
        ...
        treq.setData(
                "{\"appOrderId\":\"201304241518300018\",\"chId\":\"Zfb\",\"amount\":\"0.01\",\"chDealId\":\"2013042413817274\","
    ...
    public void testJwJkPay() throws Exception {
        ...
        treq.setAppId("101");
        treq.setData(
                "{\"appOrderId\":\"20130506155630\",\"chId\":\"jw\",\"payMethod\":\"jk\",\"appOrderTime\":\"20130506155630\","
    ...
    public void testSzfSzxPay() throws Exception {
        ...
        treq.setAppId("101");
        treq.setData(
                "{\"appOrderId\":\"20130508155630\",\"chId\":\"szf\",\"payMethod\":\"szx\",\"appOrderTime\":\"20130508155630\","
    ...
    private static String genTwoCentPayUrlForWapAli() throws Exception {
        ...
        String url = "http://222.73.61.40/pay.do?appId=101&data=" + dataString + "&sign=" + sign;
        return url;
    }
    ...
    private static String genQueryUrlForWapAli(String appOrderId) throws Exception {
        ...
        String dataString = new ObjectMapper().writeValueAsString(data);
        String sign = SecureHelper.genMd5Sign("1a2b3c4d5e6f7g8h9i0j", dataString);
        String url = "http://api.pay.gb.com/query.do?appId=101&data=" + dataString + "&sign=" + sign;
        return url;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        String appOrderId = "201306061725092000";

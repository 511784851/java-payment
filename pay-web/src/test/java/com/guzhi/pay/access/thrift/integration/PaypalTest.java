...
public class PaypalTest {
    ...
    private static String genTwoCentPayUrlForWapAli() throws Exception {
        ...
        // data.put("userIp", "115.85.144.0");
        data.put("userIp", "12454");
        data.put("unit", "USD");
        // .put("autoRedirect", "true");
        ...
        String sign = SecureHelper.genMd5Sign("1a2b3c4d5e6f7g8hyoux", dataString);
        String url = "http://payplf-tpay-test.gb.com/pay.do?appId=102&data=" + dataString + "&sign=" + sign;
        return url;
    }

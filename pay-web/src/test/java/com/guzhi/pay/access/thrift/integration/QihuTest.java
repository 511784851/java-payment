...
public class QihuTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(QihuTest.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ThreadRequestId.setRequestId("caa66786529a4f8c82c0c1dcdf90d92b");
        logger.info("[QihuGateAdapter.pay] start paying1", "ds:trace:10087");
        String appOrderTime = new SimpleDateFormat("gbgbMMddHHmmss").format(new Date());
        ...
        logger.info("[QihuGateAdapter.pay] start paying2", "ds:trace:10087");
